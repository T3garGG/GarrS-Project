...
export async function POST(req: Request) {
  ...
  if (!isPrivileged && !perms.includes("INSTAGRAM_DL")) {
  ...
  return NextResponse.json({
    downloadUrl: null,
    error: "Extractor instagram belum dipasang — ini masih stub API. Sambungkan ke lib/service pilihan lu di route.ts.",
  }, { status: 501 });
}
